...
class Command extends BaseCommand
{
    ...
    {
        \LoggerPlugin::info('执行脚本提示', ['msg' => $string]);
    ...
    {
        \LoggerPlugin::warn('执行脚本异常', ['msg' => $string]);
    ...
    {
        \LoggerPlugin::error('执行脚本出错', ['msg' => $string]);
     ...
     * @return \Generator
     */
    public function readFileWithGenerate($file)
    {
        if (!is_readable($file)) {
            $this->error("文件{$file}不可读");
            exit;
        }
